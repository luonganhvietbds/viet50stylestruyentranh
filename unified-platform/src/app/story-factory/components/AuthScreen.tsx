...
import { BookOpen, LogIn, UserPlus, Mail, ArrowLeft, KeyRound, CheckCircle } from 'lucide-react';
        ...
        try {
            if (mode === 'login') {
                ...
                if (password !== confirmPassword) {
                    return; // Will be handled by form validation
                }
        ...
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <p className="mt-6 text-center text-xs text-gray-600">
                    ...
                    <a href="#" className="text-indigo-400 hover:underline">Điều khoản dịch vụ</a>
                    {' '}và{' '}
